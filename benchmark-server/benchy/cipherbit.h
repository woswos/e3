...
class Cipherbit
{
    ...
    public:
        // Please change this to 'gate' OR 'arithmetic' based on the implementation of this class
        // Corresponding benchmarks will be applied
        std::string implementationType = "gate";
